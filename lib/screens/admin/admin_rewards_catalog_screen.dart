                      ...
                      child: Container(
                        ...
                        child: base64Image != null && base64Image!.startsWith('data:image')
                            ...
                            : const Column(
                                ...
                                children: [
                                  Icon(Icons.add_photo_alternate_rounded, color: AppTheme.primaryOrange, size: 30),
                                  SizedBox(height: 4),
                                  Text('Image', style: TextStyle(color: AppTheme.primaryOrange, fontSize: 12)),
                                ],
                              ),
                      ),
                    ),
              ...
              return Padding(
                ...
                child: SoftCard(
                  ...
                  child: ListTile(
                    ...
                    subtitle: Text('${item.pointsCost} points', style: const TextStyle(color: AppTheme.primaryOrange, fontWeight: FontWeight.bold)),
                    trailing: IconButton(
